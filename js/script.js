...
async function getSongs(folder) {
    ...
    let a = await fetch(`https://raw.githubusercontent.com/Vinith-Vj/spotify-02/main/${folder}/`);
...
async function displayAlbums () {
    let a = await fetch(`https://raw.githubusercontent.com/Vinith-Vj/spotify-02/main/songs/`);
    let response = await a.text();
    let div = document.createElement("div");
    div.innerHTML = response;
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes('/songs/')) {
            ...
            let a = await fetch(`https://raw.githubusercontent.com/Vinith-Vj/spotify-02/main/${folder}/info.json`);
